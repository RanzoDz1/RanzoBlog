...
const AR: typeof EN = {
  nav: {
    home: "الرئيسية", about: "عليا", travels: "رحلاتي", stories: "ابني موقعك",
  ...
  hero: {
    ...
    storiesBtn: "ابني موقعك ↗", travelsBtn: "شوف رحلاتي", scroll: "انزل",
  },
  about: {
    eyebrow: "على RanzoDz",
    headline1: "من الجزائر،", headline2: "لكل بلاد.",
    bio1: "أنا عبدالله، مسافر، حاكي قصص، وIRL ستريمر. خليت الراحة وراي باش نوثّق أجمل وأقسى لحظات العالم.",
    ...
    countries: "دولة",
    tags: ["صانع محتوى سفر", "IRL ستريمر", "متعدد لغات", "50+ دولة", "+مليون متابع", "عربية · دارجة · فرنسية · ألمانية"],
    timeline: [
  ...
  collab: {
    ...
    form: {
      ...
      error: "كاين مشكلة. عاود حاول من بعد شوية.",
