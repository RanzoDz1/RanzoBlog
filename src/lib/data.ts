...
export const STORIES = [
  ...
  },
  {
    ...
    color: '#be123c',
    location: 'Uganda',
    excerpt: "I walked out of a bank in Kampala and got hit from behind. Broken jaw, no hospital, a few more days to survive before the flight home.",
    body: [
      "I walked out of the bank into the afternoon heat of Kampala. The street was loud, crowded, alive. I wasn't paying attention. Someone noticed.",
      "I felt it before I understood it. A blow to the jaw from behind. Hard. The kind that tilts the world sideways and drops everything into slow motion. They wanted what was in my hands.",
      "They didn't get it. I don't know exactly how. Adrenaline has its own logic. But they were gone, and I was standing on a street I didn't know, jaw throbbing, heart louder than everything around me.",
      "I spent the next few days in Uganda with what turned out to be a broken jaw. I didn't go to a hospital. I just kept moving. Ate what I could. Talked when I had to. Counted the hours until my flight home.",
      "What Uganda gave me wasn't fear. It was awareness. The kind you can't learn from a blog or a YouTube video. You only learn it when you're standing on a street you don't know, hurting, and you realise: you have to be more present than that.",
    ],
  },
];
