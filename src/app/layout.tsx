...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "RanzoDz | Travel Creator" }],
  },
  twitter: {
    card: "summary_large_image", title: "RanzoDz | Travel. Risk. Experience.",
    description: "50+ countries. 6 continents. 1M+ followers.", images: ["/og-image.jpg"],
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Abdullah Khalfi", alternateName: "RanzoDz",
              description: "Travel content creator and IRL streamer with 50+ countries visited across 6 continents.",
              url: "https://ranzodz.com",
              sameAs: ["https://instagram.com/ranzodz","https://youtube.com/@ranzodz","https://tiktok.com/@ranzodz","https://kick.com/ranzodz"],
            }),
          }}
        />
      </head>
